...
var items = []; // state is a bunch of data that reflects the state of our applications.
...
function handleSubmit(e) {
  ...
  e.currentTarget.reset(); // fire of a custom event that will tell anyone else who cares that the items have been updated.
...
function restoreFromLocalStorage() {
  var lsItem = JSON.parse(localStorage.getItem('items'));
  console.log(lsItem);
...
},{}]},{},["../../../../../.nvm/versions/node/v14.3.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","shopping.js"], null)
